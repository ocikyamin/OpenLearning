# Tugas 8 — Authentication & Middleware
...
Buat project baru dengan Breeze dan database MySQL `db_tugas8`.
...
```sql
CREATE DATABASE db_tugas8 CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
```
